...
@Component({
  selector: 'app-new-maker-biller-bulk',
  templateUrl: './new-maker-biller-bulk.component.html',
  styleUrls: ['./new-maker-biller-bulk.component.css']
})
export class NewMakerBillerBulkComponent implements OnInit {billertype:boolean=true;
