...
@Component({
  selector: 'app-rmreportname',
  templateUrl: './rmreportname.component.html',
  styleUrls: ['./rmreportname.component.css']
})
export class RmreportnameComponent implements OnInit {
  public amt;
